...
<html lang="vi">
   <head>
      ...
      <title>{{$titletruyen->tentruyen}}</title>

      <meta name="description" content="Truyện {{$titletruyen->tentruyen}} hay nhất, xem Truyện {{$titletruyen->tentruyen}} online miễn phí" />
      <link rel="canonical" href="{{Request::url()}}">
      <link rel="next" href="" />
      <meta property="og:locale" content="vi_VN" />
      <meta property="og:title" content="Truyện {{$titletruyen->tentruyen}}" />
      <meta property="og:site_name" content="TruyenMoi">
      <meta property="og:description" content="Truyện {{$titletruyen->tentruyen}} hay nhất, xem Truyện {{$titletruyen->tentruyen}} online miễn phí" />
      <meta property="og:url" content="{{Request::url()}}" />
      @foreach ($truyen as $key => $truyens)
      <meta property="og:image" content="{{asset('uploads/truyen/'.$truyens->hinhnen)}}" />
      @endforeach
