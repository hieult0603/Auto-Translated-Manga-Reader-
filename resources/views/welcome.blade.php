...
<html lang="vi">
   <head>
      ...
      <title>Truyện Mới - Đọc truyện mới hay nhất</title>

      <meta name="description" content="Truyện Mới - Xem Truyện hay nhất, xem Truyện online miễn phí" />
      <link rel="canonical" href="{{Request::url()}}">
      <link rel="next" href="" />
      <meta property="og:locale" content="vi_VN" />
      <meta property="og:title" content="Truyện Mới - Đọc truyện mới hay nhất" />
      <meta property="og:description" content="Truyện Mới - Xem Truyện hay nhất, Truyện hay trung quốc, hàn quốc" />
      <meta property="og:url" content="{{Request::url()}}" />
      <meta property="og:site_name" content="Truyện Mới- Xem Truyện hay nhất" />
      <meta property="og:image" content="https://res.cloudinary.com/v-network/image/upload/v1663523751/favicon_h5xid7.ico" />
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="" onload="checkSizeWidth()" onscroll="myFunction()" onresize="checkSizeWidth()">
      ...
      {{-- <script>
         function changeCss () {
            ...
            this.scrollY > 200 ? document.getElementById('showstickys').style.cssText = 'position:fixed; top: 0; background: #ccc; z-index: 999; width: 100%;' : document.getElementById('showstickys').style.cssText = '';
         }
