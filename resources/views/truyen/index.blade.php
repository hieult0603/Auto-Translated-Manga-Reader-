...
<div class="showMain" style="padding: 5px;">
    ...
    <form action="{{url('/themtruyen')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="d-flex">
            <div class="w-50">
                <div class="m-2">
                    <label class="form-label">Tên truyện</label>
                    <input name="tentruyen" type="text" class="form-control" onkeyup="ChangeToSlug()" id="slug">
                </div>
                <div class="m-2">
                    <label class="form-label">Tên tiếng anh</label>
                    <input name="tentienganh" type="text" class="form-control">
                </div>
                <div class="m-2">
                ...
                <div class="m-2">
                    ...
                    <input name="tentacgia" type="text" class="form-control">
                </div>
                <div class="m-2">
            ...
            <div class="w-50">
                <div class="m-2">
                    ...
                    <textarea name="noidungtruyen" style="resize: none; overflow: auto;" rows="9" class="form-control"></textarea>
                </div>
                <div class="m-4" style="height: 270px; overflow: auto;">
                    <label class="form-label">Thể loai</label>
                    @foreach($theloai as $key => $theloai)
                    <div class="form-check">
                        <input class="form-check-input" name="theloai[]" type="checkbox" value="{{$theloai->matheloai}}" id="flexCheckDefault{{$theloai->matheloai}}">
        ...
        <button type="submit" class="btn btn-primary m-2">Thêm truyện</button>
    </form>
