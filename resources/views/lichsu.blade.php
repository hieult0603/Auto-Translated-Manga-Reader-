...
<main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
    <section id="halim-advanced-widget-2">
        ...
        <span class="label-content-truyen">Truyện đã đọc<i class='bx bxs-chevron-right'></i></span>
                    ...
                    <div class="item" style="margin: 6px;">
                        <figure class="clearfix">
                            ...
                            <div style="display: flex; justify-content: space-between; margin-top: 5px;">
                                <div></div>
                                <a href="{{url('/xoalichsu/'.$item->matruyen)}}"><span style="background: #ff0000ca; color: #fff; padding: 2px;">Xóa</span> </a>
                            </div>
